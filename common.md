...
* Chỉ có API login là có thể gọi mà không cần chứng thực 
* Check validate đối với request parameter như sau:
    * Check required: [requiredError]
    * Check data-type số: [datatypeError]
    * Check format date: [formatError]
    ...
    * Check giá trị date: [formatError]
    * Check giá trị hạng mục có list giá trị: [valueError]
    * Check tồn tại giá trị tương ứng trong DB có deleted_date = NULL đối với request parameter là id: [notExistError]
